...
function assure_stats($link) {
 ...
 `date` date NOT NULL COMMENT 'Date of the statistics.',
 ...
 `sessions` int(10) unsigned NOT NULL COMMENT 'Number of sessions currently active.',
 `IPs` int(10) unsigned NOT NULL COMMENT 'Number of different IPs that currently have an active session.',
 `max_sessions` int(10) unsigned NOT NULL COMMENT 'Maximum number of active sessions during that day.',
 `max_IPs` int(10) unsigned NOT NULL COMMENT 'Maximum number of active IPs during that day.',
 `database_requests` int(10) unsigned NOT NULL COMMENT 'Number of API requests made this day.',
 `invalid_requests` int(10) unsigned NOT NULL COMMENT 'Number of invalid API requests made this day. This is a sign of API abuse or hacking attempts.',
 `free_tokens` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Number of free tokens given out lately.',
 `errors` int(10) unsigned NOT NULL COMMENT 'Number of internal errors. This should be always zero.',
...
function assure_session($link) {
 ...
 `requests` int(10) unsigned NOT NULL COMMENT 'Number of database requests this session has made.',
...
function assure_btc_tx($link) {
 ...
 `type` varchar(64) NOT NULL COMMENT 'Message content type.',
...
function assure_order($link) {
 ...
 `output` text CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT 'Response given by the executive bitbroker.',
