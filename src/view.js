                ...
                if ("out" in json && json.out.length > 0) {
                    ...
                    if (blockchain_file !== null) {
                        payload = btoa(blockchain_file);
                             if (CG_TX_TYPE === 'jpg')  type = 'image/jpeg;base64';
                        else if (CG_TX_TYPE === 'png')  type = 'image/png;base64';
                        else if (CG_TX_TYPE === 'gif')  type = 'image/gif;base64';
                        else if (CG_TX_TYPE === 'txt')  type = 'text/plain;charset=utf-8;base64';
                        else if (CG_TX_TYPE === 'html') type = 'text/html;charset=utf-8;base64';
                        else if (CG_TX_TYPE === 'md') {
